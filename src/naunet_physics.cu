...
__device__ __host__ double GetMu(double *y) {
    return (y[IDX_DI]*0.0 + y[IDX_DII]*0.0 + y[IDX_GRAINI]*0.0 + y[IDX_HI]*1.007 +
        y[IDX_HII]*1.007 + y[IDX_HM]*1.007 + y[IDX_H2I]*2.014 +
        y[IDX_H2II]*2.014 + y[IDX_HDI]*1.007 + y[IDX_HeI]*4.002 +
        y[IDX_HeII]*4.002 + y[IDX_HeIII]*4.002 + y[IDX_eM]*0.0) / (y[IDX_DI] +
        y[IDX_DII] + y[IDX_GRAINI] + y[IDX_HI] + y[IDX_HII] + y[IDX_HM] +
